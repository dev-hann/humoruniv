...
void main() {
  group('ContentBlockView', () {
    ...
    group('VideoBlock controls', () {
      ...
      testWidgets('should show fullscreen icon for VideoBlock',
          (tester) async {
        const block = VideoBlock(url: 'https://example.com/video.mp4');
    ...
    testWidgets('should show NSFW placeholder for NSFW ImageBlock when hideNsfw is true', (tester) async {
      const block = ImageBlock(url: 'https://example.com/nsfw.jpg', isNsfw: true);
    ...
    testWidgets('should not show placeholder for NSFW ImageBlock when hideNsfw is false', (tester) async {
      const block = ImageBlock(url: 'https://example.com/nsfw.jpg', isNsfw: true);
    ...
    testWidgets('should not show placeholder for safe ImageBlock when hideNsfw is true', (tester) async {
      const block = ImageBlock(url: 'https://example.com/safe.jpg', isNsfw: false);
    ...
    testWidgets('should reveal NSFW image after tapping placeholder', (tester) async {
      const block = ImageBlock(url: 'https://example.com/nsfw.jpg', isNsfw: true);
